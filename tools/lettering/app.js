 ...
 try{
  ...
  while(Date.now()<deadline){
   ...
   if(s.state==='awaiting_render'){
    const out=await window.PaperQuality.search(s.briefs,s.scene,snapshot,img,{placement:payload.placement,action,copyMode:payload.copyMode,isCancelled:()=>creativeCancelled});drafts=out.candidates;
